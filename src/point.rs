...
impl Point {
    ...
    #[inline]
    pub fn zero() -> Point {
        Point((Field256::zero(P), Field256::zero(P)))
    }
...
mod tests {
    ...
    fn point_add() {
        ...
        assert_eq!(
            Field256::new(
                U256::new(
                    0xc6047f9441ed7d6d3045406e95c07cd8u128,
                    0x5c778e4b8cef3ca7abac09b95c709ee5u128
                ),
                P
            ),
            x
        ...
        assert_eq!(
            Field256::new(
                U256::new(
                    0x1ae168fea63dc339a3c58419466ceaeeu128,
                    0xf7f632653266d0e1236431a950cfe52au128
                ),
                P
            ),
            y
        ...
        assert_eq!(
            ...
            Field256::new(
                U256::new(
                    0x342119815c0f816f31f431a9fe98a6c7u128,
                    0x6d11425ecaeaecf2d0ef6def197c56b0u128
                ),
                P
            )
        );
        ...
        assert_eq!(
            ...
            Field256::new(
                U256::new(
                    0x38f37014ce22fc29cf19f28a5ce4da09u128,
                    0x1445536c3e2cff318ba07c2a3048f518u128
                ),
                P
            )
        );
        ...
        assert_eq!(
            ...
            Field256::new(
                U256::new(
                    0xf9308a019258c31049344f85f89d5229u128,
                    0xb531c845836f99b08601f113bce036f9u128
                ),
                P
            )
        );
        ...
        assert_eq!(
            ...
            Field256::new(
                U256::new(
                    0x388f7b0f632de8140fe337e62a37f356u128,
                    0x6500a99934c2231b6cb9fd7584b8e672u128
                ),
                P
            )
        );
