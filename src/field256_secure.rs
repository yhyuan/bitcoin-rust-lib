...
use crate::error::{ArithmeticError, BitcoinError, CryptographicError, Result};
use crate::u256::U256;
use crate::{arithmetic_error, crypto_error};
...
impl Sub for Field256 {
    ...
    fn sub(self, other: Field256) -> Field256 {
        ...
        self.checked_sub(other)
            .unwrap_or_else(|_| Field256::zero(self.p))
    }
}
